<template>
  <section class="cpt-app-header">
    <div class="search-input">
      ...
      <input v-model.trim="keyword" @keyup.enter="fetchExp" @focus="showView('search')" />
    </div>
    <ul class="oper-btns">
      <li class="btn" v-for="btn in btnList" :key="btn.text" :class="btn.class" @click="btn.handler">
